    ...
    <div class="panel">
      ...
      <div style="overflow-x: auto;">
        <table>
          ...
          <tbody>
            <!-- ── SAMPLE PLACEHOLDER ROWS (remove when DB is connected) ── -->
            <tr>
              <td><strong>Nasugbu Rural Health Unit</strong></td>
            ...
            <tr>
              <td><strong>Calayo Barangay Health Center</strong></td>
            ...
            <tr>
              <td><strong>Malapad BHS</strong></td>
              <td>Barangay Health Station</td>
              <td>Brgy. Malapad</td>
              <td>—</td>
              <td>Midwife Ana Reyes</td>
