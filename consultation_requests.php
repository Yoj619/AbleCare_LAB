 ...
 * - Replace dummy arrays below with actual DB queries (PDO/MySQLi).
...
// TODO: SELECT * FROM consultation_requests WHERE status='pending' ORDER BY date_requested DESC
$pendingRequests = [
    ['id' => 1, 'patient_name' => 'Juan dela Cruz',  'caregiver' => 'Maria Santos',   'caregiver_contact' => '0912-345-6789', 'datetime' => 'March 30, 2026 – 2:30 PM',  'condition' => 'Elevated blood pressure (160/95), persistent headache for 3 days'],
    ['id' => 2, 'patient_name' => 'Rosa Martinez',   'caregiver' => 'Pedro Martinez',  'caregiver_contact' => '0923-456-7890', 'datetime' => 'March 29, 2026 – 10:15 AM', 'condition' => 'Diabetes monitoring – blood sugar levels fluctuating'],
    ['id' => 3, 'patient_name' => 'Carlos Reyes',    'caregiver' => 'Ana Reyes',       'caregiver_contact' => '0934-567-8901', 'datetime' => 'March 28, 2026 – 4:00 PM',  'condition' => 'Post-therapy assessment needed for mobility improvement'],
];

// TODO: SELECT * FROM consultation_requests WHERE status='accepted' ORDER BY date_requested DESC
$acceptedRequests = [
    ['id' => 4, 'patient_name' => 'Linda Garcia', 'caregiver' => 'Jose Garcia', 'caregiver_contact' => '0945-678-9012', 'datetime' => 'March 27, 2026 – 11:00 AM', 'condition' => 'Respiratory concerns and shortness of breath'],
];

// TODO: SELECT * FROM consultation_requests WHERE status='completed' ORDER BY date_completed DESC
$completedRequests = [
    ['id' => 5, 'patient_name' => 'Roberto Santos', 'caregiver' => 'Carmen Santos', 'caregiver_contact' => '0989-012-3456', 'datetime' => 'March 20, 2026 – 2:00 PM',  'condition' => 'Follow-up cardiac medication adjustment',    'completed_date' => 'March 28, 2026'],
    ['id' => 6, 'patient_name' => 'Maria Lopez',    'caregiver' => 'Juan Lopez',    'caregiver_contact' => '0990-123-4567', 'datetime' => 'March 18, 2026 – 10:30 AM', 'condition' => 'Physical therapy progress assessment',         'completed_date' => 'March 27, 2026'],
    ['id' => 7, 'patient_name' => 'Fernando Cruz',  'caregiver' => 'Isabel Cruz',   'caregiver_contact' => '0901-234-5678', 'datetime' => 'March 15, 2026 – 3:45 PM',  'condition' => 'Diabetes management and diet consultation',    'completed_date' => 'March 25, 2026'],
];

// TODO: SELECT * FROM consultation_requests WHERE status='declined' ORDER BY date_declined DESC
$declinedRequests = [
    ['id' => 8,  'patient_name' => 'Miguel Fernandez',  'caregiver' => 'Sofia Fernandez',  'caregiver_contact' => '0956-789-0123', 'datetime' => 'March 25, 2026 – 3:15 PM',  'condition' => 'Chronic pain management – specialized neurology consultation needed',   'reason' => 'Out of specialty area – Patient requires neurologist consultation'],
    ['id' => 9,  'patient_name' => 'Teresa Villanueva', 'caregiver' => 'Antonio Villanueva','caregiver_contact' => '0967-890-1234', 'datetime' => 'March 24, 2026 – 9:30 AM',  'condition' => 'Cardiac rehabilitation assessment and monitoring',                      'reason' => 'Requires cardiologist – Patient needs specialized cardiac care'],
    ['id' => 10, 'patient_name' => 'Ricardo Bautista',  'caregiver' => 'Elena Bautista',   'caregiver_contact' => '0978-901-2345', 'datetime' => 'March 23, 2026 – 1:45 PM',  'condition' => 'Advanced dermatological condition requiring specialist',                'reason' => 'Specialty mismatch – Dermatology consultation recommended'],
];
