...
(function init(): void {
    ...
    let currentStep  = 1;
    let pinnedLat: number | null = null;
    let pinnedLng: number | null = null;
    ...
    const progressFill  = document.getElementById('stepProgressFill') as HTMLElement;
    const errorBanner   = document.getElementById('formErrorBanner')  as HTMLElement;
    const coordsDisplay = document.getElementById('coordsDisplay')    as HTMLElement;
    const loginRow      = document.getElementById('loginRow')         as HTMLElement;
    const form          = document.getElementById('caregiverForm')    as HTMLFormElement;
    ...
    function showBannerErrors(errors: string[]): void {
    ...
    function showStep(step: number | 'success'): void {
        document.querySelectorAll('.wizard-step').forEach(s => {
            (s as HTMLElement).hidden = (s as HTMLElement).dataset.step !== String(step);
        });

        const nav = document.getElementById('wizardNav') as HTMLElement;
    ...
    function renderReview(): void {
        const rev = document.getElementById('reviewSummary') as HTMLElement;
