 ...
 * - Replace dummy $stats, $consultationRequests, $therapySchedule arrays
...
$stats = [
    'active_patients'    => ['count' => 48, 'change' => '+12%', 'label' => 'Active Patients'],
    'pending_consults'   => ['count' => 12, 'change' => '+5%',  'label' => 'Pending Consultation Requests', 'badge' => 12],
    'therapy_sessions'   => ['count' => 7,  'change' => '4 completed', 'label' => "Today's Therapy Sessions"],
];

$consultationRequests = [
    // TODO: Replace with: SELECT * FROM consultation_requests WHERE status='pending' ORDER BY date_requested DESC LIMIT 5
    ['id' => 1, 'patient_name' => 'Juan dela Cruz',  'caregiver' => 'Maria Santos',  'condition' => 'Elevated blood pressure, persistent headache',    'date_requested' => 'March 30, 2026'],
    ['id' => 2, 'patient_name' => 'Rosa Martinez',   'caregiver' => 'Pedro Martinez', 'condition' => 'Diabetes monitoring and medication review',        'date_requested' => 'March 29, 2026'],
    ['id' => 3, 'patient_name' => 'Carlos Reyes',    'caregiver' => 'Ana Reyes',      'condition' => 'Post-therapy assessment needed',                   'date_requested' => 'March 28, 2026'],
    ['id' => 4, 'patient_name' => 'Linda Garcia',    'caregiver' => 'Jose Garcia',    'condition' => 'Respiratory concerns and shortness of breath',      'date_requested' => 'March 28, 2026'],
    ['id' => 5, 'patient_name' => 'Roberto Santos',  'caregiver' => 'Carmen Santos',  'condition' => 'Follow-up on cardiac medication',                  'date_requested' => 'March 27, 2026'],
];

$therapySchedule = [
    // TODO: Replace with: SELECT * FROM therapy_sessions WHERE session_date = CURDATE() ORDER BY session_time ASC
    ['time' => '9:00 AM',  'patient' => 'Maria Lopez',   'therapy_type' => 'Physical Therapy',     'status' => 'completed'],
    ['time' => '10:30 AM', 'patient' => 'Juan dela Cruz', 'therapy_type' => 'Physical Therapy',    'status' => 'completed'],
    ['time' => '2:00 PM',  'patient' => 'Rosa Martinez', 'therapy_type' => 'Occupational Therapy', 'status' => 'scheduled'],
    ['time' => '3:30 PM',  'patient' => 'Carlos Reyes',  'therapy_type' => 'Speech Therapy',       'status' => 'scheduled'],
];
        ...
        <div class="content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-change">↗ <span><?= $stats['active_patients']['change'] ?></span></div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-change">↗ <span><?= $stats['pending_consults']['change'] ?></span></div>
                </div>
                <!-- Today's Sessions -->
                <div class="stat-card">
                    ...
                    <div class="stat-change">↗ <span><?= $stats['therapy_sessions']['change'] ?></span></div>
                </div>
            </div>
