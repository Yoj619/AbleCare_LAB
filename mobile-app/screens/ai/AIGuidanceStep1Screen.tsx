        ...
        <ScrollView contentContainerStyle={styles.chat} showsVerticalScrollIndicator={false}>
          {MESSAGES.map(m => (
            <View key={m.id} style={m.from === 'user' ? styles.userBlock : styles.aiBlock}>
              {m.from === 'user' && (
                <View style={styles.userBubble}><Text style={styles.userTxt}>{m.text}</Text></View>
              )}
              <Text style={styles.time}>{m.time}</Text>
              {m.from === 'ai' && (
                <View style={styles.aiBubble}><Text style={styles.aiTxt}>{m.text}</Text></View>
              )}
            </View>
          ))}
        </ScrollView>
