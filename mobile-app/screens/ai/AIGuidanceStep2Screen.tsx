...
const MESSAGES = [
  { id: '1', from: 'user', text: 'What foods are good for stroke recovery?', time: '2:15 PM' },
  {
    id: '2', from: 'ai', time: '2:20 PM',
    text: 'Foods Good for Stroke Recovery\n\n• Fruits and vegetables rich in vitamins and antioxidants\n• Whole grains such as oatmeal, brown rice, and whole wheat bread\n• Lean proteins like fish, chicken, eggs, and beans\n• Foods rich in healthy fats such as nuts, avocado, and olive oil\n• Low-fat dairy products for calcium and protein\n• Plenty of water to stay hydrated\n\nIt is also recommended to limit salty, sugary, fatty, and highly processed foods to help maintain healthy blood pressure and heart health.',
  },
];

export default function AIGuidanceStep2Screen() {
